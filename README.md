# Script ZEROVPN V8-Websocket
 Welcome 

 <h2 align="center">AutoScript VPN By ZEROVPN <img src="https://img.shields.io/badge/Version-6.0-blue.svg"></h2>
...
## INSTALLATION SCRIPT
  ...
  ```html
  sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/zerovpn3/test/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh
...
## Description :
 ...
 >>> Server Information & Other Features
   - Timezone                 : Asia/DKI_JAKARTA (GMT +7)
   - Fail2Ban                 : [ON]
   - DDOS Dflate              : [ON]
   - IPtables                 : [ON]
...
<p align="center">
  <a><img src="https://img.shields.io/badge/Copyright%20©-ARNOLD%20AutoScriptVPN%202022.%20All%20rights%20reserved...-blueviolet.svg" style="max-width:200%;">
    </p>
   </p>
