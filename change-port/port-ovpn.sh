...
############## WELCOME TO ARNOLD STORE ###############
############## By ARNOLD ###############
setenv FRIENDLY_NAME "ARNOLD TCP"
client
dev tun
proto tcp
remote $domain 1194
...
############## WELCOME TO ARNOLD STORE ###############
############## By ARNOLD ###############
setenv FRIENDLY_NAME "ARNOLD UDP"
client
dev tun
proto udp
remote $domain 2200
...
setenv FRIENDLY_NAME "ARNOLD OHP"
http-proxy $MYIP $vpn
...
[Unit]
Description=Direct Squid Proxy For OpenVPN TCP By ARNOLD 
...
############## WELCOME TO ARNOLD STORE ###############
############## BY ARNOLD ###############
setenv FRIENDLY_NAME "ARNOLD SSL"
client
dev tun
proto tcp
remote $domain $vpn
