...
adminip=$( curl -sS https://raw.githubusercontent.com/zerovpn3/allow/main/accessmenu | grep $MYIP )
...
sleep 1
cek=$( curl -sS https://raw.githubusercontent.com/zerovpn3/allow/main/ipvps.conf | awk '{print $5}' | grep $daftar )
if [[ $daftar = $cek ]]; then
...
git config --global user.name "zerovpn3"
...
git branch -M main
git remote add origin https://github.com/zerovpn3/allow.git
git push -f https://${tokengit}@github.com/zerovpn3/allow.git
...
links3="sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/huaweipadu/backdoor/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh"
clear
...
echo "  Script Ver    : Multiport_Arnold"
echo -e "\033[0;34m----------------------------------------\033[0m"
...
clear
echo -e "\033[0;34m----------------------------------------\033[0m"
echo -e "\E[44;1;39m    MENU ADD IP MULTIPORT WS ARNOLD  \E[0m"
echo -e "\033[0;34m----------------------------------------\033[0m"
echo ""
...
echo -e ""
echo -e "\033[0;34m----------------------------------------\033[0m"
echo -e "\E[44;1;39m      SCRIPT MULTIPORT WS ARNOLD     \E[0m"
echo -e "\033[0;34m----------------------------------------\033[0m"
echo ""
