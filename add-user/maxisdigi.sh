...
patchtls=/arnold-vmesswstls
patchnontls=/arnold-vmesswsntls
...
echo -e "\e[$line═════════════════════════════════\e[m"
echo -e "ARNOLD STORE $creditt Shop"
...
patchtls=/arnold-vlesswstls
patchnontls=/arnold-vlesswsntls
uuid=$(cat /proc/sys/kernel/random/uuid)
read -p "   Bug Address (Example: www.google.com) : " address
read -p "   Bug SNI/Host (Example : m.facebook.com) : " sni
read -p "   Expired (days) : " masaaktif
...
patchtls=/arnold-trojanwstls
patchnone=/arnold-trojanwsntls
read -p "   Bug Address (Example: www.google.com) : " address
